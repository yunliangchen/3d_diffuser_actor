...
do
    CUDA_LAUNCH_BLOCKING=1 torchrun --nproc_per_node $ngpus --master_port $RANDOM \
        ...
        --checkpoint /lustre/fsw/portfolios/nvr/users/lawchen/project/3d_diffuser_actor/train_logs/droid_sparse/diffusion_taskABC_D-C192-B15-lr1e-4-DI1-20-H2-DT50-backboneclip-S256,256-R0-wd5e-3-usewrist1/last.pth
    sleep 1m
done
