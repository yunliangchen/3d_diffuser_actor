...
do
    CUDA_LAUNCH_BLOCKING=1 torchrun --nproc_per_node $ngpus --master_port $RANDOM \
        main_trajectory_droid_sparse_sorted_1k_2d.py \
        --backbone $backbone \
        --dataset $dataset \
        --valset $valset \
        ...
        --checkpoint /lustre/fsw/portfolios/nvr/users/lawchen/project/3d_diffuser_actor/train_logs/droid_sparse_1k_2d/diffusion_taskABC_D-C192-B10-lr1e-4-DI1-20-H2-DT50-backboneclip-S256,256-R0-wd5e-3-usewrist0/last.pth
    sleep 1m
done
