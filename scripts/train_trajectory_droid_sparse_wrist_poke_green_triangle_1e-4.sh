main_dir=poke_green_triangle

dataset=/lustre/fsw/portfolios/nvr/users/lawchen/droid_raw/2024-06-04-new_data/2024-06-04-poke-green-triangle
valset=/lustre/fsw/portfolios/nvr/users/lawchen/droid_raw/2024-06-04-new_data/2024-06-04-poke-green-triangle
...
do
    CUDA_LAUNCH_BLOCKING=1 torchrun --nproc_per_node $ngpus --master_port $RANDOM \
        ...
        --checkpoint /lustre/fsw/portfolios/nvr/users/lawchen/project/3d_diffuser_actor/train_logs/poke_green_triangle/diffusion_taskABC_D-C192-B10-lr1e-4-DI1-20-H2-DT50-backboneclip-S256,256-R0-wd5e-3-usewrist1/last.pth
    sleep 1m
done
